...
public class AWSClient {
	...
	AWSClient(){
		try {
    		credentials = new PropertiesCredentials(Manager.class.getResourceAsStream(_propertiesFilePath));
	...
	public int getNumOfRunningInstances() {
...
//	}
	...
	public void startNode(String manager_or_worker) {
		...
		case "manager": if (!isManagerNodeExists()) startManager(); 
						break;
...
//		_sqsClient.deleteMessage(queueUrl, message.getReceiptHandle());
	...
	public void deleteAllQueues() {
		List<String> queueList = _sqsClient.listQueues().getQueueUrls();
		System.out.println(queueList.size() + " queues are open");
		for(String queue: queueList){
			System.out.println(queue);
			_sqsClient.deleteQueue(queue);
		}
	}
}
